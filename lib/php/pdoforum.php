            ...
            if (acl(1)) {
                ...
                if ($c) {
                    if ($t) {
                        ...
                        msg('The topic field must not be empty');
                    }
                } else {
                    msg('The content field must not be empty');
                }
            } else {
                msg('You must sign in to add topics');
            }
        }
            ...
            if (acl(1)) {
                ...
                if ($s) {
                    if ($c) {
                        ...
                        msg('The category name field must not be empty');
                    }
                } else {
                    msg('The subject field must not be empty');
                }
            } else {
                msg('You must sign in to add topics');
            }
 ...
 VALUES (:name, :desc)';
        ...
        if (!empty($_POST)) {
            if (acl(1)) {
                ...
                msg('You must sign in to add categories');
            }
        }
            ...
            if (!acl(1)) {
              ...
              if ($p == $user['passwd']) {
                  ...
                  msg('Password does not match');
                    ...
                    msg('The username field must not be empty');
                }
            } else {
                msg('You are already signed in, you can <a href="?a=signout">sign out</a> if you want');
            }
        }
                    ...
                    if ($u !== $user['uid']) {
                        if ($e !== $user['email']) {
                          ...
                          'created' => date('Y-m-d H:i:s'), ])) {
                                                    ...
                                                    msg('Problem adding user details, please contact the administrator', 'danger');
                                                }
                                            } else {
                                                msg('Passwords do not match, please try again');
                                            }
                                        } else {
                                            msg('Password must contains at least one lower case letter');
                                        }
                                    } else {
                                        msg('Password must contains at least one captital letter');
                                    }
                                } else {
                                    msg('Password must contains at least one number');
                                }
                            } else {
                                msg('Passwords must be at least 10 characters');
                            }
                        } else {
                            msg('Email address already exists, please user a different one');
                        }
                    } else {
                        msg('Username already exists, please user a different one');
                    }
                } else {
                    msg('Please provide a valid email address');
                }
            } else {
                msg('Please provide a valid username using only alphanumeric characters');
            }
        }
  ...
  LIMIT 1';
        ...
        if (($res1 = qry($this->dbh, $sql1)) !== false) {
            if (!empty($res1)) {
                foreach ($res1 as $r1) {
                    if (($res2 = qry($this->dbh, $sql2, ['id' => $r1['id']])) !== false) {
                        ...
                        msg('Last topic for '.$r1['cat_name'].' could not be displayed');
                    }
            ...
            't' => $buf2,
                ...
                $buf1 .= '<tr><td width="75%">No categories defined yet</td><td></td></tr>';
            }
        } else {
            msg('The categories could not be displayed, please try again later');
        }
  ...
  WHERE topic_cat = :id';
                ...
                if ($topicsresult === false) {
                    ...
                    if (empty($topicsresult)) {
                        ...
                        foreach ($topicsresult as $topicrow) {
                            $tbody .= '
            <tr>
              <td width="75%">
